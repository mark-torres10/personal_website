...
Taking a "Prompting 101" class should give you the basis of what a good prompt looks like. In addition to those, here are common mistakes I've seen from years of working with LLMs and helping others learn how to use them.
...
These example prompts are examples that you can start with, and I'd suggest diving even deeper and being even more prescriptive and detailed to improve performance.
